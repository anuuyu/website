...
export const CardsPage = ({ title, description, imgSrc, href }) => (
  <div className="md p-4 md:w-1/2" style={{ maxWidth: '544px' }}>
    <div
      className={`${
        imgSrc && 'h-full'
...
export const BooksCard = ({ title, description, imgSrc, href, author }) => (
      ...
      {imgSrc &&
        (href ? (
          <Link href={href} aria-label={`Link to ${title}`}>
            <Image
              alt={title}
              src={`/static/images/page/books/${imgSrc}`}
...
export const ToolsPage = ({ title, description, imgSrc, href }) => (
  <div className="md p-4 md:w-1/2" style={{ maxWidth: '544px' }}>
    <div
      className={`${
        imgSrc && 'h-full'
      ...
      {imgSrc &&
        (href ? (
          <Link href={href} aria-label={`Link to ${title}`}>
            <Image
              alt={title}
              src={`/static/images/page/tools/${imgSrc}`}
              className="object-contain md:h-36 lg:h-48"
              width={544}
              height={306}
            />
